export default {
    ...
    search_for_rest_and_add: 'Recherchez votre restaurant et ajoutez vous en choisissant: Vous êtes serveur',
    ...
    your_tip_to_waiter:'Votre pourboir au serveur',
    enter_your_amount:'Entrez votre montant',
    validate:'Valider',
    ...
    help_us_improve: 'Aidez-nous à améliorer notre app. Donnez nous le nom de votre serveur',
    will_contact_shortly: 'Nous le contacterons prochainement pour l’ajouter dans notre app.',
    name_of_your_server:'Le nom de votre serveur',
    add: 'Ajouter',

    // Popup thanks for vote
    thanks_for_vote:'Merci pour votre vote',
    will_contact_by_email:'Nous vous contacterons par email pour vous offire un coupon très prochainement.',
