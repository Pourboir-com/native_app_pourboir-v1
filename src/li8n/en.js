export default {
  ...
  confirm: 'Confirm',
  i_prof: 'I am a catering professional',
  area_prof:'Professional Area',
  prof_pofile: 'I create my professional profile',
  i_manage: 'I manage a restaurant',
  past_pos: 'Past position',
  current_pos: 'Current position',
  look_job: 'Looking for a job',
  yes: "Yes",
  no: "No",
  contact_me: 'Contact me',
  add_curr_pos: 'Add your current position',
  since: 'since',
  be_patient: 'Be patient, we are looking for the establishments closest to you',
