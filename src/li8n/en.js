export default {
  ...
  //Global Header
  must_loggedIn: 'Please turn on your wifi to access the app!',
  ...
  delete_dish: 'You are about to delete this dish. ',
  ...
  discoverImg_text:
    'Change the discover images of your page, by adding upto five pictures here.',
  advance_settings: 'Advanced Settings',
  link_ig_acc:
    'Linked your instagram account and make sure to display all the latest post on your page automatically.',
  user_id: 'User ID',
